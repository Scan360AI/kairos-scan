 ...
 * Versione 1.1 - Dati Aggiornati per KAIROS S.R.L.
 */
...
function getTrendRicaviEbitdaData_Dashboard() {
    ...
    return {
        ...
        datasets: [
             {
                 label: "Ricavi (€)",
                 data: [561500, 3335654, 11515149], // Valori assoluti
             ...
             {
                 label: "EBITDA (€)",
                 data: [45600, 92758, 444854], // Valori assoluti
...
function getTrendPfnEbitdaData_Dashboard() {
    ...
    return {
         ...
         datasets: [
             {
                 label: "PFN/EBITDA",
                 data: [-0.99, -0.79, -0.16], // Valori del rapporto (PFN negativa = surplus)
                 borderColor: 'rgb(77, 140, 87)',
...
function getMainMetricsData() {
    // console.log("Fornitura dati per mainMetricsChart (Report Parte 1)");
     return {
         ...
         datasets: [
             { label: "Ricavi (€000)", data: [562, 3336, 11515], backgroundColor: "rgba(25, 25, 112, 0.7)" }, // Dati in migliaia
             { label: "EBITDA (€000)", data: [46, 93, 445], backgroundColor: "rgba(77, 140, 87, 0.7)" },
             { label: "Patrimonio Netto (€000)", data: [50, 108, 471], backgroundColor: "rgba(217, 140, 0, 0.7)" }
         ]
     };
}
function getCurrentAssetsLiabilitiesData() {
    ...
    // Dati estratti dai report - corrisponde a Capitale Circolante, Attivo Corrente, Passivo Corrente
     return {
         labels: ["2023", "2024"],
         datasets: [
             { label: "Attivo Corrente", data: [1554975, 1389795], backgroundColor: "rgba(25, 25, 112, 0.7)" },
             { label: "Passivo Corrente", data: [1449207, 977974], backgroundColor: "rgba(214, 34, 70, 0.7)" },
             { label: "Capitale Circolante Netto", data: [32576, 341182], backgroundColor: "rgba(77, 140, 87, 0.7)" }
         ]
     };
}
...
function getMarginalityData() {
    // console.log("Fornitura dati per marginalityChart (Report Parte 2)");
     return {
         labels: ["2022", "2023", "2024"],
         datasets: [
            { label: "Valore Aggiunto %", data: [100.0, 99.6, 96.0], borderColor: "rgba(25, 25, 112, 1)", fill: false },
            { label: "Margine di Contribuzione %", data: [8.1, 3.2, 8.9], borderColor: "rgba(42, 58, 128, 1)", fill: false },
            { label: "EBITDA %", data: [8.1, 2.8, 3.9], borderColor: "rgba(77, 140, 87, 1)", fill: false },
            { label: "EBIT %", data: [8.0, 2.8, 3.9], borderColor: "rgba(217, 140, 0, 1)", fill: false }
         ]
     };
}
function getProfitabilityIndicesData() {
    ...
    return {
        labels: ["2022", "2023", "2024"],
        datasets: [
            { label: "ROE %", data: [63.65, 54.22, 77.07], borderColor: "rgba(25, 25, 112, 1)", backgroundColor: "rgba(25, 25, 112, 0.2)", fill: true},
            { label: "ROI %", data: [1049.29, 265.48, 110.99], borderColor: "rgba(77, 140, 87, 1)", backgroundColor: "rgba(77, 140, 87, 0.2)", fill: true},
            { label: "ROS %", data: [8.0, 2.8, 3.9], borderColor: "rgba(217, 140, 0, 1)", backgroundColor: "rgba(217, 140, 0, 0.2)", fill: true}
        ]
    };
}
function getLeverageData() {
     ...
     return {
         labels: ["2023", "2024"],
         datasets: [
             { label: "ROI (%)", data: [265.48, 110.99], backgroundColor: "rgba(25, 25, 112, 0.7)"},
             { label: "ROE (%)", data: [54.22, 77.07], backgroundColor: "rgba(77, 140, 87, 0.7)"}
         ]
     };
}
function getBenchmarkRadarData() {
    ...
    return {
        ...
        datasets: [
            {
                label: "KAIROS S.R.L.", // Valori > 100 = Migliore della media
                data: [2452, 49, 1110, 287, 20, 625, 1000], // DATI NORMALIZZATI STIMATI
...
function getAssetsData() {
    ...
    const originalData = [28138, 30000, 1500, 0, 1319156, 70667]; // Immob. Mat, Fin, Immat, Magazzino, Crediti, Liquidità
...
function getLiabilitiesData() {
    ...
    const originalData = [471487, 0, 0, 977974, 0]; // PN, Debt MLT, Debt BT, Debt Comm., Fondi
    const total = originalData.reduce((a, b) => a + b, 0);
     return {
...
function getInvestmentsStructureData() {
    ...
    return {
        labels: ["2022", "2023", "2024"],
        datasets: [
             { label: "Immobilizzazioni", data: [2364, 2364, 59638], backgroundColor: "rgba(25, 25, 112, 0.7)", stack: "Stack 0" },
             { label: "Crediti commerciali", data: [498388, 728954, 88907], backgroundColor: "rgba(77, 140, 87, 0.7)", stack: "Stack 0" },
             { label: "Rimanenze", data: [0, 0, 0], backgroundColor: "rgba(217, 140, 0, 0.7)", stack: "Stack 0" },
             { label: "Liquidità", data: [45216, 73192, 70667], backgroundColor: "rgba(79, 109, 122, 0.7)", stack: "Stack 0" }
        ]
    };
}
function getEquityCompositionData() {
    ...
    const originalData = [10000, 98132, 363354, 0]; // Capitale Sociale, Riserve, Utile, Utili a nuovo
    const total = originalData.reduce((a, b) => a + b, 0);
     return {
...
function getPfnTrendData() {
    ...
    return {
         ...
         datasets: [
             ...
             { label: "Liquidità", data: [45216, 73192, 70667], type: "bar", backgroundColor: "rgba(77, 140, 87, 0.7)", yAxisID: 'y'},
             { label: "PFN", data: [-45216, -73192, -70667], type: "line", borderColor: "rgba(25, 25, 112, 1)", fill: false, yAxisID: 'y' }
         ]
     };
}
...
function getDebtSustainabilityData() {
    // console.log("Fornitura dati per debtSustainabilityChart (Report Parte 4)");
     ...
     return {
         ...
         datasets: [
             { label: "KAIROS S.R.L.", data: [625, 1000, 2477, 1250, 48, 62], backgroundColor: "rgba(25, 25, 112, 0.2)", borderColor: "rgba(25, 25, 112, 1)" }, // Valori > 100 = Migliore
             { label: "Target/Benchmark", data: [67, 67, 60, 70, 500, 75], backgroundColor: "rgba(77, 140, 87, 0.2)", borderColor: "rgba(77, 140, 87, 1)" }
         ]
     };
}
function getDebtCostData() { // Grafico Capacità Indebitamento
    ...
    return {
         labels: ["2022", "2023", "2024"],
         datasets: [
             { label: "EBITDA (€000)", data: [46, 93, 445], type: "bar", yAxisID: "y", backgroundColor: "rgba(77, 140, 87, 0.7)" },
             { label: "Capacità Teorica Indeb. (3x EBITDA, €000)", data: [138, 279, 1335], type: "line", yAxisID: "y", borderColor: "rgba(25, 25, 112, 1)", fill: false }
         ]
     };
}
...
function getWorkingCapitalCycleData() {
    ...
    return {
        ...
        datasets: [
            { label: "KAIROS S.R.L. (Giorni)", data: [3, 0, 28, -25], backgroundColor: "rgba(25, 25, 112, 0.7)" },
            { label: "Benchmark Settore (Giorni)", data: [60, 45, 45, 60], backgroundColor: "rgba(77, 140, 87, 0.7)" }
        ]
    };
}
function getCashFlowWaterfallData() {
    ...
    // Implementazione con barre semplici per rappresentare la cascata
     return {
         ...
         datasets: [{
             data: [444854, 0, 1302481, 54749, -57274, -2525, 0, 0, -2525],
...
function getCashFlowTrendData() {
    ...
    return {
        labels: ["2022", "2023", "2024"],
        datasets: [
            { label: "Cash Flow Operativo", data: [33089, 27976, 54749], borderColor: "rgba(77, 140, 87, 1)", fill: true, backgroundColor: "rgba(77, 140, 87, 0.1)"},
            { label: "Cash Flow Investimenti", data: [-960, 0, -57274], borderColor: "rgba(214, 34, 70, 1)", fill: true, backgroundColor: "rgba(214, 34, 70, 0.1)" },
            { label: "Variazione Netta di Cassa", data: [32129, 27976, -2525], borderColor: "rgba(25, 25, 112, 1)", fill: true, backgroundColor: "rgba(25, 25, 112, 0.1)" }
        ]
    };
}
function getCashFlowProjectionData() {
    ...
    return {
        ...
        datasets: [
            { label: "Cash Flow Operativo", data: [54749, 282101, 282101, 282101, 282101], type: 'bar', backgroundColor: "rgba(79, 109, 122, 0.7)", yAxisID: 'y' },
            { label: "Variazione Debiti Fin.", data: [0, 0, 0, 0, 0], type: 'bar', backgroundColor: "rgba(214, 34, 70, 0.7)", yAxisID: 'y' },
            { label: "Liquidità Finale", data: [70667, 352768, 634869, 916969, 1199070], type: 'line', borderColor: "rgba(77, 140, 87, 1)", fill: false, yAxisID: 'y1' }
        ]
    };
}
...
function getZscoreData() {
    ...
    return {
        labels: ["2022", "2023", "2024"],
        datasets: [
            { label: "Z-Score", data: [null, null, 25.70], borderColor: "rgba(25, 25, 112, 1)", fill: false },
...
function getRiskIndicatorsData() {
    ...
    return {
        ...
        datasets: [{
             label: "KAIROS S.R.L.",
             data: [1110, 65, 1000, 791, 2000, 156], // Normalizzati dai dati dei report
    ...
    // console.log("Fornitura dati per sensitivityChart (Report Parte 6)");
     return {
         ...
         datasets: [{
             ...
             data: [-43.31, 76.39, 3, -3], // Dati dai report - Basati sull'analisi di sensitività
